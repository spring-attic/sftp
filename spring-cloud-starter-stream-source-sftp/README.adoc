...
$$sftp.task.task-launcher-output$$:: $$Set to output a task launch request. Default is `NONE`.$$ *($$TaskLaunchRequestType$$, default: `$$<none>$$`, possible values: `NONE`,`DATAFLOW`,`STANDALONE`)*
